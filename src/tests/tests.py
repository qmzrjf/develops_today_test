...
def test_posts_and_comments():
    ...
    response_post = client.post(url_posts,
                                data={
                                    "title": "Hello",
                                    "votes": 2780,
                                    "author": 'марина',
    ...
    response_patch = client.patch(url_post,
                                  data={
                                      "votes": 3100},
                                  format='json', )
    ...
    response_put = client.put(url_post,
                              data={
                                  "title": "Not_Hello",
                                  "votes": 22,
                                  "author": 'Татьяна',
    ...
    response_post = client.post(url_comments,
                                data={
                                    "post": 1,
                                    "content": 'Nice post!',
                                    "author": 'Kevin',
    ...
    url_comment = reverse('api-blog:comment', args=[f'{response_post.json().get("id")}'])
    response_get = client.get(url_comment)
    assert response_get.status_code == 200

    response_patch = client.patch(url_comment,
                                  data={
                                      "content": "Great Post!"},
                                  format='json', )
    assert response_patch.status_code == 200
    ...
    response_put = client.put(url_comment,
                              data={
                                  "post": 1,
                                  "content": 'Like it!',
                                  "author": 'John',
